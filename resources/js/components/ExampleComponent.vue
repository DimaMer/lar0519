<template>
    <div>
        ...
        <div>
            <input type="submit" value="send to site">
...
<button class="btn" type="button" @click="search()" v-if="!loading">Search!</button>
        ...
        <div v-if="view" display="none">
            <p class="page">
                <div class="page"> found-{{job.length}}-jobs</div>
                <button type="button" @click="prevPage">Previous</button>
               <span> {{currentPage}} </span>
                <button type="button" @click="nextPage">Next</button>
                <button type="button" @click="allpage">All page</button>
                <span> {{Math.ceil(job.length/4)}}-pages</span>
            ...
            <table class="table">
                ...
                <tr v-for="(product, key) in sorted">
                    ...
                    <td>{{product.vacancyInfoWrapper}}</td>
